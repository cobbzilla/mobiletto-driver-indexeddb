...
import { M_FILE, M_DIR, isAsyncGenerator, isReadable, logger, MobilettoError, MobilettoNotFoundError, } from "mobiletto-base";
const IDB_SCHEMA_VERSION = 1;
const ROOT_STORE = "rootStore";
export const IdbInfo = {
    driver: "indexeddb",
    scope: "local",
};
export class StorageClient {
    constructor(dbName, opts) {
        ...
        this.info = () => (Object.assign({ canonicalName: () => `indexeddb:${this.dbName}` }, IdbInfo));
